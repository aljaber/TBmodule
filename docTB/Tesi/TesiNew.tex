...
%__Inizio descrizione moduli_________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
...
\subsection{Visualizzazione Richieste}
\begin{figure}[!ht]
\centering
...
\hypertarget{api}{}
\textbf{API:}
Le Application Programming Interface (Interfaccia di Programmazione di un'Applicazione), sono ogni insieme di procedure disponibili al programmatore, raggruppate solitamente per formare un set di strumenti specifici per un determinato compito.\\ Sono un metodo per ottenere un'astrazione, di solito tra l'hardware e il programmatore, o tra software a basso ed alto livello. Le API stesse sono un'astrazione: il software che fornisce una certa API \`e detto implementazione dell'API.
